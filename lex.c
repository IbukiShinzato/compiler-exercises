...
{
	return do_check_simbols(c, white_space);
}

static int is_numbers(char c)
{
	return do_check_simbols(c, numbers);
}

static int is_operators(char c)
{
	return do_check_simbols(c, operators);
}
